...
import DonacionStepper from '@/components/DonacionStepper.vue';
export default {
    data: () => ({
        datos: [],
        articulo: {},
    ...
    mounted() {
        this.requestDonaciones();
    },

    methods: {
        requestDonaciones() {
            requests.getDonaciones().then((data) => {
                this.datos = data;
        ...
        requestArticulo(id) {
            requests.getOneDonacion(id).then((data) => {
